...
namespace WattnPC
{
    public partial class mainForm : Form
    {
        ...
        Bitmap kartenBitmap; //Converts the Image that contains all cards to a bitmap
        ...
        private async void mainForm_Load(object sender, EventArgs e)
        {
            ...
            cf.ShowDialog();
            kartenBitmap = (cf.KartenBitmap ?? new Bitmap(Properties.Resources.ALLIN1WATTN));
            cf.Dispose();
        ...
        private void PosSizeAnpassung() //is called everytime the form is resized or something needs to be placed to the original spot
        {
            ...
            {
                Console.WriteLine($"lol was to lazy to actually put a fix in here xDDD {ex}");
            }
        ...
        private void AIPlace(byte difficulty, byte playernumber, List<wattKarte> wattRangliste)
        {
            ...
            if (pictureBoxMainKarte.Image != midKarte) //for design purposes, looks weird if this is not done
            {
                ...
                {
                    goto setbox;
                    throw up; //throw up because this is disgusting 
                }
            }
